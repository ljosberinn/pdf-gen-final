    ...
    <tbody>
        ...
        foreach ($data as $dataset) {
            ...
            <tr ' .$trClass. '>
              ...
              <td>
                <form action="api/deletePDF.php" method="POST">
                  <button class="button is-danger is-small" name="pdfId" value="' .$dataset['day']. '">
                    <span class="icon">
              ...
              <td>
                <form action="api/editPDF.php" method="POST">
                  <button class="button is-info is-small" name="pdfId" value="' .$dataset['day']. '">
                    <span class="icon">
